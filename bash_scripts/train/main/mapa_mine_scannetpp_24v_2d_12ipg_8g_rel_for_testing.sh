...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29591 \
    scripts/train.py \
    machine=dgx02 \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/mapa_mine_scannetpp_24v_2d_12ipg_8g_rel_for_testing' \
