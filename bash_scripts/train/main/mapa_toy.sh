...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29502 \
    scripts/train.py \
    machine=dgx02 \
    dataset=mine_waymo_toy.yaml dataset.num_workers=12 \
    ...
    model.pretrained='${root_experiments_dir}/mapanything/training/all_param_tune/checkpoint-last.pth' \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/mapa_waymo_toy_debug1'
