...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29503 \
    ...
    model=mapanything_chunked_aat_w_ref_view_24layers \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/fusion_only_tune_w_ref_view_scannetpp_24layers'
