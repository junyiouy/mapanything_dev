...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29594 \
    ...
    loss=overall_pairwise_loss_weigh_pm_higher_point_lower_diversity \
    ...
    train_params=diversity_fix_params \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/prechunk_diversity_fix_v1' \
