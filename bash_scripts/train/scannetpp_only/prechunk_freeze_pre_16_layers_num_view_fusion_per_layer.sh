...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29593 \
    ...
    model=mapanything_prechunk_fusion_16 \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/prechunk_freeze_pre_16_layers_num_view_fusion_per_layer' \
    model.pretrained='/wekafs/ict/junyiouy/map-anything/checkpoints/facebook_map-anything.pth' 

# 这个把冻结的部分变为16层，每层都做view compuression