...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29504 \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/fusion_only_tune_w_ref_view_load_weight_scale_variable_view_no_v0_conversion_w_xyz_overfit_scannetpp'
