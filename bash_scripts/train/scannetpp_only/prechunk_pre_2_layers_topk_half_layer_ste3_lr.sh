...
torchrun --nproc_per_node ${NUM_GPUS} --master_port 29595 \
    ...
    train_params=lower_encoder_lr_ste3lr \
    ...
    hydra.run.dir='${root_experiments_dir}/mapanything/training/prechunk_pre_2_layers_topk_half_layer_ste3_lr' \
    model.pretrained='/wekafs/ict/junyiouy/map-anything/experiments/mapanything/training/prechunk_pre_2_layers_topk_half_layer_ste3/checkpoint-last.pth' 

# 这一版在上一版的基础上去掉了全部的global attention，并且chunk size从2变成了1
